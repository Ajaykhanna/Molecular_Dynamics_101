...
1. **Prepare Your Input Files**:
   ...
   - Ensure your trajectory file is correctly formatted.
   - Create a solvent charge file with appropriate charges.
   - (Optional) Prepare dye MM charge files if you plan to convert dyes to MM charges.
...
3. **Check the Output**:
   ...
   - Navigate to the directories created for each frame.
   - Verify that the output files are correctly generated.

4. **Use the Output Files**:

   - Use the TeraChem and Gaussian input files for your simulations.
   - Refer to the software documentation for instructions on running simulations with these files.
