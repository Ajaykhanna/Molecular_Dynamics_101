...
with open(outfile, 'w') as fileobj:
    ...
    fileobj.write("mpirun -np 32 $AMBERHOME/bin/sander.MPI -O -i equil.in -o equil.out -p solute_solvent_drop.prmtop -c heat.ncrst -r equil.ncrst -x equil.mdcrd -inf equil.info -ref heat.ncrst \n")
