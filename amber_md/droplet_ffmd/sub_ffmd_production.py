...
def generate_minimization_banner():
    ...
    banner = """
    +--------------------------------------------------+
    |  Submitting NVT Equilibration Job Using Amber 20 |
    +--------------------------------------------------+
    """
    return banner
...
with open(outfile, 'w') as fileobj:
    ...
    fileobj.write("mpirun -np 32 $AMBERHOME/bin/sander.MPI -O -i production.in -o production.out -p solute_solvent_drop.prmtop -c equil.ncrst -r production.ncrst -x production.mdcrd -inf production.info -ref equil.ncrst \n")
